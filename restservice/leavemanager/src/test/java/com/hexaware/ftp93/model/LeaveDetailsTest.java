 ...
 */
 ...
 /**
  ...
  @Test
    ...
    new Expectations() {
      {
        ...
        em.add(new LeaveDetails(3003, 1275, 2, sdf.parse("2018-11-22"), sdf.parse("2018-11-23"), LeaveType.EL,
            LeaveStatus.PENDING, "Health problem", sdf.parse("2018-11-19"), "NULL"));
        em.add(new LeaveDetails(3001, 1231, 2, sdf.parse("2018-12-22"), sdf.parse("2018-12-23"), LeaveType.EL,
            LeaveStatus.DENIED, "function", sdf.parse("2018-12-12"), "Always taking leaves"));
        em.add(new LeaveDetails(3004, 2548, 2, sdf.parse("2018-11-22"), sdf.parse("2018-11-23"), LeaveType.EL,
    ...
    leave[0] = new LeaveDetails(3003, 1275, 2, sdf.parse("2018-11-22"), sdf.parse("2018-11-23"), LeaveType.EL,
            LeaveStatus.PENDING, "Health problem", sdf.parse("2018-11-19"), "NULL");
    leave[1] = new LeaveDetails(3001, 1231, 2, sdf.parse("2018-12-22"), sdf.parse("2018-12-23"), LeaveType.EL,
            LeaveStatus.DENIED, "function", sdf.parse("2018-12-12"), "Always taking leaves");
    leave[2] = new LeaveDetails(3004, 2548, 2, sdf.parse("2018-11-22"), sdf.parse("2018-11-23"), LeaveType.EL,
            LeaveStatus.APPROVED, "Health problem", sdf.parse("2018-11-19"), "Granted");
  ...
  public final void testapplyProcess(@Mocked final LeaveDetailsDAO dao) throws ParseException {
    ...
    {
      {
        dao.insert(3001, 3, "2019-02-06", "2019-02-08", "EL", "function", "2019-01-02");
      }
    };
    new MockUp<LeaveDetails>()
    {
    ...
    new Expectations() {
      {
        dao.count(3001, "2019-02-06", "2019-02-08");
      }
    };
    // new Expectations() {
    //   {
    ...
    String act = LeaveDetails.applyProcess(3001, "2019-02-06", "2019-02-08", "EL", "function");
    String exp =  "**** Your leave request succcessfully recored " + "form :" + "2019-02-06"
                + " - " + "2019-02-08" + " for: " + 3 + "days" + " ****";
    assertEquals(exp, act);
    String actual = LeaveDetails.applyProcess(1000, "2019-02-06", "2019-02-08", "EL", "function");
    String expec =  "**** Your leave request succcessfully recored " + "form :" + "2019-02-06"
                + " - " + "2019-02-08" + " for: " + 3 + "days" + " ****";
    assertEquals(expec, actual);
    int ac = LeaveDetails.countNo(3001, "2019-12-28", "2019-12-30");
    int ex = 0;
    assertEquals(ex, ac);
 ...
 /**
  ...
  public final void testMgrComments(@Mocked final LeaveDetailsDAO dao) throws ParseException {
    ...
    final LeaveDetails ld2 = new LeaveDetails(2000, 100, 2, sd.parse("2018-12-08"), sd.parse("2018-12-09"),
        LeaveType.EL, LeaveStatus.PENDING, "fever", sd.parse("2018-12-05"), "approve");
