...
public class Employee {
  ...
  */
  ...
  /**
   *
   * @param argEmpSSLBal to set employee id.
   */
  public final void setEmpSSLBal(final int argEmpSSLBal) {
    this.empSSLBal = argEmpSSLBal;
  }
